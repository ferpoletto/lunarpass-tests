...
- **Parametros:**
  - `ref` (string): O identificador do nó retornado por `browser_snapshot` ou `browser_find`.
...
- **Parametros:**
  - `ref` (string): O identificador do elemento.
...
- **Parametros:**
  - `ref` (string): O identificador do elemento select.
